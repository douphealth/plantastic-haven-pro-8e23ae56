        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            {plants.map((plant) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className={`text-xs font-bold ${healthColor(plant.health)}`}>
          ...
          <div className="lg:col-span-2 bg-card rounded-2xl shadow-elevated p-8 border border-border">
            ...
            <div className="flex gap-3 mt-6">
              <Button variant="hero" className="flex-1 rounded-xl">Water Now</Button>
              <Button variant="heroOutline" className="flex-1 rounded-xl">View Journal</Button>
            </div>
          </div>
        </div>
      </div>
